...
## Prerequisite
Installed SingularityCE version >= 4.0.1. Theoretically, the configurations below work with unprivileged installation(s) of the SingularityCE software, it is not tested.
